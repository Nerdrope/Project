...
execute as @e[type=area_effect_cloud,tag=aj.chest.Chest] if score @s aj.id = #this.aj.id aj.i run function chest:animations/key/__generated__/execute/364
execute as @e[type=area_effect_cloud,tag=aj.chest.group] if score @s aj.id = #this.aj.id aj.i run function chest:animations/key/__generated__/execute/368
execute as @e[type=area_effect_cloud,tag=aj.chest.key] if score @s aj.id = #this.aj.id aj.i run function chest:animations/key/__generated__/execute/372